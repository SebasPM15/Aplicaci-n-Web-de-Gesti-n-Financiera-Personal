...
<div class="card">
    ...
    <form action="RegistrarMovimientosController" method="post">
        <input type="hidden" name="ruta" value="guardarTransferencia">
        <span class="card__title">Formulario de Transferencia</span>
        <p class="card__content">Ingrese sus datos para guardar una Transferencia.</p>
        <div class="card__form">
            ...
            <select id="categoria" name="categoria" required>
                <%-- Mostrar el mensaje de la categoría por defecto --%>
                <c:choose>
                    <c:when test="${empty categoriaTransferencia}">
                        <option value="" selected>Seleccionar Categoría</option>
                    </c:when>
                    <c:otherwise>
                        <option value="${categoriaTransferencia.idCat}" selected>${categoriaTransferencia.tipoCat}</option>
                    </c:otherwise>
                </c:choose>
            ...
            <input type="submit" value="Guardar Transferencia">
