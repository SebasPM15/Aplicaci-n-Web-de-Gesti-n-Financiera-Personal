...
<div class="card">
    ...
    <form action="RegistrarMovimientosController" method="post">
        <input type="hidden" name="ruta" value="guardarEgreso">
        <span class="card__title">Formulario de Egreso</span>
        <p class="card__content">Ingrese sus datos para guardar un Egreso.</p>
        <div class="card__form">
            ...
            <input type="submit" value="Guardar Egreso">
